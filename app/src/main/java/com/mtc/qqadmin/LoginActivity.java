...
import static com.mtc.qqadmin.DbQuery.checkPermissions;
import static com.mtc.qqadmin.DbQuery.loadData;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            checkPermissions(uid, new com.mtc.qqadmin.OnCompleteListener() {
                                @Override
                                public void onSuccess() {

                                    if(DbQuery.authorised)
                                    {
                                        loadData(new com.mtc.qqadmin.OnCompleteListener() {
